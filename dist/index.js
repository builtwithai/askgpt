...
/**
 * Represents an AskLLM instance that can be used to get completions for prompts.
 * @class
 * @param {string} url - The URL of the LLM API.
 * @param {string} apiKey - The API key to authenticate with the LLM API.
 * @param {Object} [options] - Additional options to pass to the LLM API.
 */
class AskLLM {
    ...
    /**
     * Asynchronously gets a completion for a given prompt using the LLM API.
     * @async
     ...
     * @throws {Error} If there was an error fetching the completion.
     */
...
const getModelResponse = __nccwpck_require__(781);
